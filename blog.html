...
<div class="wrapper"> 
  ...
  <header class="header-style-2">
    <nav class="navbar navbar-expand-lg"> <a class="navbar-brand" href="index-2.html"><img src="images/h2logo.png" alt=""></a>
      ...
      <div class="collapse navbar-collapse" id="navbarSupportedContent">
        <ul class="navbar-nav mr-auto">
          ...
          <li class="nav-item dropdown"> <a class="nav-link dropdown-toggle" href="events-grid.html"  role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false"> Events </a>
            <ul class="dropdown-menu" >
          ...
          <li class="nav-item dropdown"> <a class="nav-link dropdown-toggle" href="causes.html"  role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false"> Causes </a>
            <ul class="dropdown-menu" >
          ...
          <li class="nav-item dropdown"> <a class="nav-link dropdown-toggle" href="blog.html"  role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false"> Blogs </a>
            <ul class="dropdown-menu" >
          ...
          <li class="nav-item dropdown"> <a class="nav-link dropdown-toggle" href="contact.html"  role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false"> Contact </a>
            <ul class="dropdown-menu" >
        ...
        <ul class="topnav-right">
          ...
          <li class="dropdown"> <a class="cart-icon" href="#" role="button" id="cartdropdown" data-toggle="dropdown"> <i class="fas fa-shopping-cart"></i></a>
            <div class="dropdown-menu cart-box" aria-labelledby="cartdropdown"> Recently added item(s)
              <ul class="list">
                <li class="item"> <a href="#" class="preview-image"><img class="preview" src="images/pro.jpg" alt=""></a>
  ...
  <section class="wf100 p100 inner-header">
    <div class="container">
      ...
      <ul>
        ...
        <li><a href="#">Blog Full with Sidebar</a></li>
      </ul>
    </div>
  </section>
  <!--Inner Header End--> 
      ...
      <div class="row">
        <div class="col-md-9"> 
          ...
          <div class="blog-posts"> 
            <!--Blog Post Start-->
            <div class="blog-post">
              <div class="blog-thumb"> <a href="#"><i class="fas fa-link"></i></a> <img src="images/blog/bf1.jpg" alt=""> </div>
              <div class="blog-txt">
                <h3><a href="#">Awareness Campaign to Save & Forest Planting</a></h3>
                <ul class="post-meta">
                  <li> <a href="#"><i class="fas fa-user-circle"></i> John Ashley</a> </li>
                  <li> <a href="#"><i class="fas fa-calendar-alt"></i> 29 September, 2018</a> </li>
                  <li> <a href="#"><i class="fas fa-comments"></i> 134 Comments </a> </li>
                  <li class="post-tags"><i class="fas fa-tags"></i> <a href="#">Plant</a>, <a href="#">Trees</a>, <a href="#">Water</a>, <a href="#">Recycling</a> </li>
                </ul>
                ...
                <a href="#" class="read-post">Read Post</a> </div>
            </div>
            <!--Blog Post End--> 
            <!--Blog Post Start-->
            <div class="blog-post">
              <div class="blog-thumb"> <a href="#"><i class="fas fa-link"></i></a> <img src="images/blog/bf2.jpg" alt=""> </div>
              <div class="blog-txt">
                <h3><a href="#">Fusce porttitor ex quis viverra interdum</a></h3>
                <ul class="post-meta">
                  <li> <a href="#"><i class="fas fa-user-circle"></i> John Ashley</a> </li>
                  <li> <a href="#"><i class="fas fa-calendar-alt"></i> 29 September, 2018</a> </li>
                  <li> <a href="#"><i class="fas fa-comments"></i> 134 Comments </a> </li>
            ...
            <div class="blog-post">
              <div class="blog-slider">
                <div id="bslider" class="owl-carousel owl-theme">
                  <div class="item"> <img src="images/blog/bf4.jpg" alt=""> </div>
                  <div class="item"> <img src="images/blog/bf3.jpg" alt=""> </div>
                  <div class="item"> <img src="images/blog/bf2.jpg" alt=""> </div>
                </div>
              </div>
              <div class="blog-txt">
                <h3><a href="#">Nulla hendrerit neque ut eros blandit maximus</a></h3>
                <ul class="post-meta">
                  <li> <a href="#"><i class="fas fa-user-circle"></i> John Ashley</a> </li>
                  <li> <a href="#"><i class="fas fa-calendar-alt"></i> 29 September, 2018</a> </li>
                  <li> <a href="#"><i class="fas fa-comments"></i> 134 Comments </a> </li>
            ...
            <div class="blog-post">
              <div class="blog-video">
                <iframe src="https://player.vimeo.com/video/154852371"></iframe>
              </div>
              <div class="blog-txt">
                <h3><a href="#">Sed dapibus dui vehicula neque varius finibus</a></h3>
                <ul class="post-meta">
                  <li> <a href="#"><i class="fas fa-user-circle"></i> John Ashley</a> </li>
                  <li> <a href="#"><i class="fas fa-calendar-alt"></i> 29 September, 2018</a> </li>
                  <li> <a href="#"><i class="fas fa-comments"></i> 134 Comments </a> </li>
            ...
            <div class="blog-post">
              <div class="blog-txt">
                <h3><a href="#">Cras varius erat quis turpis dignissim mattis</a></h3>
                <ul class="post-meta">
                  <li> <a href="#"><i class="fas fa-user-circle"></i> John Ashley</a> </li>
                  <li> <a href="#"><i class="fas fa-calendar-alt"></i> 29 September, 2018</a> </li>
                  <li> <a href="#"><i class="fas fa-comments"></i> 134 Comments </a> </li>
            ...
            <div class="blog-post">
              <div class="blog-audio">
                <iframe src="https://w.soundcloud.com/player/?url=https%3A//api.soundcloud.com/tracks/171442160&amp;color=%23ff5500&amp;auto_play=false&amp;hide_related=false&amp;show_comments=true&amp;show_user=true&amp;show_reposts=false&amp;show_teaser=true"></iframe>
              </div>
              <div class="blog-txt">
                <h3><a href="#">Vestibulum et leo sed odio blandit eleifend</a></h3>
                <ul class="post-meta">
                  <li> <a href="#"><i class="fas fa-user-circle"></i> John Ashley</a> </li>
                  <li> <a href="#"><i class="fas fa-calendar-alt"></i> 29 September, 2018</a> </li>
                  <li> <a href="#"><i class="fas fa-comments"></i> 134 Comments </a> </li>
            ...
            <div class="blog-post blog-link">
              <div class="blog-txt">
                <h4> <a href="#">https://themeforest.net/user/XYZ Themes</a> </h4>
                <ul class="post-meta">
                  <li> <a href="#"><i class="fas fa-user-circle"></i> John Ashley</a> </li>
                  <li> <a href="#"><i class="fas fa-calendar-alt"></i> 29 September, 2018</a> </li>
                  <li> <a href="#"><i class="fas fa-comments"></i> 134 Comments </a> </li>
            ...
            <!--Blog Post Start-->
            <div class="blog-post">
              <div class="blog-thumb"> <a href="#"><i class="fas fa-link"></i></a> <img src="images/blog/bf3.jpg" alt=""> </div>
              <div class="blog-txt">
                <h3><a href="#">In eleifend tortor in lobortis semper</a></h3>
                <ul class="post-meta">
                  <li> <a href="#"><i class="fas fa-user-circle"></i> John Ashley</a> </li>
                  <li> <a href="#"><i class="fas fa-calendar-alt"></i> 29 September, 2018</a> </li>
                  <li> <a href="#"><i class="fas fa-comments"></i> 134 Comments </a> </li>
        ...
        <div class="row">
          <div class="col-lg-3 col-md-6 col-sm-6"> 
            ...
            <div class="footer-widget">
              ...
              <a href="#" class="lm">About us</a> </div>
            <!--Footer Widget End--> 
          </div>
          <div class="col-lg-3 col-md-6 col-sm-6"> 
            <!--Footer Widget Start-->
          ...
          <div class="col-lg-3 col-md-6 col-sm-6"> 
            ...
            <div class="footer-widget">
              <div id="fpro-slider" class="owl-carousel owl-theme"> 
                ...
                <div class="item">
                  <div class="f-product"> <img src="images/fpro1.jpg" alt="">
                    <div class="fp-text">
                      <h6><a href="#">Buy T-Shirts</a></h6>
                      <strong>$19.00</strong> </div>
                  </div>
                </div>
                <!--Footer Product End--> 
                <!--Footer Product Start-->
