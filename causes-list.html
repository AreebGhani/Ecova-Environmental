                  ...
                  <div class="row">
                     <div class="col-lg-9 col-md-8">
                        ...
                        <div class="campaign-box">
                           <div class="campaign-thumb"> <a href="#"><i class="fas fa-link"></i></a> <img src="images/causes/cl1.jpg" alt=""> </div>
                           <div class="campaign-txt">
                              <h4><a href="#">Let’s Safe our Planet by Stop
                                 Global Warming</a>
                              </h4>
                        ...
                        <!--Cause start -->
                        <div class="campaign-box">
                           <div class="campaign-thumb"> <a href="#"><i class="fas fa-link"></i></a> <img src="images/causes/cl2.jpg" alt=""> </div>
                           <div class="campaign-txt">
                              <h4><a href="#">Fusce eu lectus eleifend, varius erat a, mollis felis</a>
                              </h4>
                              <ul class="participants">
                                 <li><img src="images/u1.jpg" alt=""></li>
                                 <li><img src="images/u2.jpg" alt=""></li>
                        ...
                        <!--Cause start -->
                        <div class="campaign-box">
                           <div class="campaign-thumb"> <a href="#"><i class="fas fa-link"></i></a> <img src="images/causes/cl3.jpg" alt=""> </div>
                           <div class="campaign-txt">
                              <h4><a href="#">Nam et diam sollicitudin mauris semper bibendum</a>
                              </h4>
                              <ul class="participants">
                                 <li><img src="images/u1.jpg" alt=""></li>
                                 <li><img src="images/u2.jpg" alt=""></li>
                        ...
                        <!--Cause start -->
                        <div class="campaign-box">
                           <div class="campaign-thumb"> <a href="#"><i class="fas fa-link"></i></a> <img src="images/causes/cl4.jpg" alt=""> </div>
                           <div class="campaign-txt">
                              <h4><a href="#">Praesent tristique libero in convallis luctus</a>
                              </h4>
                              <ul class="participants">
                                 <li><img src="images/u1.jpg" alt=""></li>
                                 <li><img src="images/u2.jpg" alt=""></li>
                        ...
                        <!--Cause start -->
                        <div class="campaign-box">
                           <div class="campaign-thumb"> <a href="#"><i class="fas fa-link"></i></a> <img src="images/causes/cl5.jpg" alt=""> </div>
                           <div class="campaign-txt">
                              <h4><a href="#">Sed tristique elit vitae aliquam viverra</a>
                              </h4>
                              <ul class="participants">
                                 <li><img src="images/u1.jpg" alt=""></li>
                                 <li><img src="images/u2.jpg" alt=""></li>
